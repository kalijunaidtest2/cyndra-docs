!function () {
    try {
        var e = "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
            t = Error().stack;
        t && (e._sentryDebugIds = e._sentryDebugIds || {}, e._sentryDebugIds[t] = "04af1ee6-106a-4d16-a24c-ed5a0f0db47e", e._sentryDebugIdIdentifier = "sentry-dbid-04af1ee6-106a-4d16-a24c-ed5a0f0db47e")
    } catch (e) {
    }
    ...
    86534: function () {
        (function () {
            ...
            function e(e) {
                ...
                document.addEventListener("keydown", function (n) {
                    n.metaKey || n.altKey || n.ctrlKey || (s(e.activeElement) && o(e.activeElement), t = !0)
                    ...
                    var n, i, u;
                    s(e.target) && (t || (i = (n = e.target).type, "INPUT" === (u = n.tagName) && r[i] && !n.readOnly || "TEXTAREA" === u && !n.readOnly || n.isContentEditable)) && o(e.target)
        ...
        var i = n(52322), r = n(83470), s = n.n(r), o = n(77134), u = n.n(o), a = n(81229), c = n.n(a);
        n(86534);
        var d = n(26736);
        ...
        function l(e) {
            ...
            return (0, i.jsxs)(d.Z, {
                children: [(0, i.jsx)(c(), {
                    id: "401c1a897a9ce4e0",
                    dynamic: [s().style.fontFamily, u().style.fontFamily],
                    children: `:root{--font-inter:${s().style.fontFamily};--font-jetbrains-mono:${u().style.fontFamily}}`
                }), (0, i.jsx)("main", {
                    className: c().dynamic([["401c1a897a9ce4e0", [s().style.fontFamily, u().style.fontFamily]]]),
                    children: (0, i.jsx)(t, {
                        ...n,
                        className: c().dynamic([["401c1a897a9ce4e0", [s().style.fontFamily, u().style.fontFamily]]]) + " " + (n && null != n.className && n.className || "")
                    })
                })]
            })
        }
        ...
        class r extends i.Component {
            ...
            componentDidCatch(e, t) {
                console.log({error: e, errorInfo: t})
            }
        ...
        var e = window;
        e.__sentryRewritesTunnelPath__ = void 0, e.SENTRY_RELEASE = {id: "68e4b67b2721901a60e097782e29bf44191e2114"}, e.__sentryBasePath = void 0, e.__rewriteFramesAssetPrefixPath__ = "/mintlify-assets"
    }, 76071: function (e, t, n) {
        "use strict";
        var i = n(34406);
        n(81633);
        var r = n(2784), s = r && "object" == typeof r && "default" in r ? r : {default: r},
            o = void 0 !== i && i.env && !0, u = function (e) {
                return "[object String]" === Object.prototype.toString.call(e)
            }, a = function () {
                function e(e) {
                    var t = void 0 === e ? {} : e, n = t.name, i = void 0 === n ? "stylesheet" : n, r = t.optimizeForSpeed,
                        s = void 0 === r ? o : r;
                    c(u(i), "`name` must be a string"), this._name = i, this._deletedRulePlaceholder = "#" + i + "-deleted-rule____{}", c("boolean" == typeof s, "`optimizeForSpeed` must be a boolean"), this._optimizeForSpeed = s, this._serverSheet = void 0, this._tags = [], this._injected = !1, this._rulesCount = 0;
                ...
                return t.setOptimizeForSpeed = function (e) {
                    ...
                    if (c(u(e), "`insertRule` accepts only strings"), this._optimizeForSpeed) {
                        var n = this.getSheet();
                    ...
                    if (this._optimizeForSpeed) this.replaceRule(e, ""); else {
                        var t = this._tags[e];
        ...
        function h(e, t) {
            if (!t) return "jsx-" + e;
            var n = String(t), i = e + n;
            return l[i] || (l[i] = "jsx-" + d(e + "-" + n)), l[i]
        }

        function f(e, t) {
            var n = e + t;
            return l[n] || (l[n] = t.replace(/__jsx-style-dynamic-selector/g, e)), l[n]
        }

        var m = function () {
            function e(e) {
                var t = void 0 === e ? {} : e, n = t.styleSheet, i = void 0 === n ? null : n, r = t.optimizeForSpeed,
                    s = void 0 !== r && r;
                this._sheet = i || new a({
                    name: "styled-jsx",
                    optimizeForSpeed: s
                }), this._sheet.inject(), i && "boolean" == typeof s && (this._sheet.setOptimizeForSpeed(s), this._optimizeForSpeed = this._sheet.isOptimizeForSpeed()), this._fromServer = void 0, this._indices = {}, this._instancesCounts = {}
            }
            ...
            return t.add = function (e) {
                ...
                var n = this.getIdAndRules(e), i = n.styleId, r = n.rules;
                ...
                var t = e.children, n = e.dynamic, i = e.id;
                if (n) {
                    var r = h(i, n);
                    return {
                        styleId: r, rules: Array.isArray(t) ? t.map(function (e) {
                            return f(r, e)
                        }) : [f(r, t)]
                    }
                }
                return {styleId: h(i), rules: Array.isArray(t) ? t : [t]}
        ...
        var p = s.default.useInsertionEffect || s.default.useLayoutEffect, _ = new m;

        function y(e) {
            var t = _ || r.useContext(v);
            return t && p(function () {
    ...
    }, 81229: function (e, t, n) {
        "use strict";
        e.exports = n(76071).style
    }, 81633: function () {
    }, 37843: function () {
    }, 83470: function (e) {
        e.exports = {
            style: {fontFamily: "'__Inter_a4e4e2', '__Inter_Fallback_a4e4e2'", fontStyle: "normal"},
            className: "__className_a4e4e2",
            variable: "__variable_a4e4e2"
        }
    }, 77134: function (e) {
        e.exports = {
            style: {
                fontFamily: "'__JetBrains_Mono_3bbdad', '__JetBrains_Mono_Fallback_3bbdad'",
                fontStyle: "normal"
            }, className: "__className_3bbdad", variable: "__variable_3bbdad"
        }
    }, 34406: function (e) {
        ...
        function l() {
            c && i && (c = !1, i.length ? a = i.concat(a) : d = -1, a.length && h())
        }
        ...
        r.nextTick = function (e) {
            ...
            a.push(new f(e, t)), 1 !== a.length || c || u(h)
    ...
    e.O(0, [9774, 179], function () {
        return t(73918), t(86570), t(37043)
    }), _N_E = e.O()
}]);